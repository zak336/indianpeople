...
const plans = [
  {
    ...
    per: "7 days · refundable deposit ₹19,999",
    description: "A structured week in Varkala for remote professionals who want coastal time without stepping away from work.",
    features: [
      "6 nights, boutique 3–4★ Varkala property",
      "Breakfast + lunch daily & 2 excursion lunches",
  ...
  },
  {
    ...
    per: "14 days · early-bird price · refundable deposit ₹29,999",
    description: "Two full weeks in Varkala with a private room, dedicated desk, reliable connectivity, meals, and weekend experiences.",
    features: [
      "13 nights, private ensuite room",
      "Breakfast + lunch daily & 2 excursion lunches",
      "Dedicated ergonomic desk & primary + backup internet",
      "2 curated weekend day trips & local transport",
      "Community evening sessions",
